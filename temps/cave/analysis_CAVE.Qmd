...
The primary aim of this study was to investigate **whether the Emotion conveyed by a video (Positive, Neutral, Negative) influenced psychomotor behavior and time processing ability**. For simplicity, we will consider only the **behavioral responses**:
