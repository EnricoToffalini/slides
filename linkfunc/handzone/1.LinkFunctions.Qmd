...
- ***Logit***: "*thinking in terms of odds ratios makes sense*"; a linear increase in predictors multiplies the *odds* of an event happening; chance of: diagnosis, consumer choice / purchase, career growth of an employee, admission to a university program, a random user clicking on our add

- ***Probit***: "*thinking about an underlying Gaussian distribution makes sense*"; when a linear increase in predictor reflects a linear increase in an underlying normally-distributed trait; chance of: detecting a signal (normally-distributed noise in sensory processes), correctly answering a question / a math problem / passing an exam; most of the above for logit but when the focus is on *traits* as predictors (?)
