...
As shown <a href="5.Diagnostics.html" target=_blank>here</a>, wrong link function can still be detected because it cause poor fit of the data and a larger BIC if:
